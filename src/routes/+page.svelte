...
<body class="bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black">
    <div class="flex flex-col justify-center items-center h-screen w-screen">
        <div class="mt-[-10%]">
            ...
            <p class="text-9xl font-black text-gray-900 dark:text-white text-center">FLUTTER</p>
            <p class="text-9xl font-black text-gray-900 dark:text-white text-center">DEVELOPER</p>
            <div class="">
        ...
        <br>
        <div class="flex flex-row gap-10 grid-rows-3 mt-6">
            <Icons/>
        </div>
    </div>
    <div id="projetos"  class="h-screen">
        <div>
            <h1 class="pb-10 text-7xl font-black text-gray-900 dark:text-white text-center">PROJETOS</h1>
        </div> 
        <div class="flex justify-center gap-6">
            <h1 class="text-5xl text-gray-400  text-center">DESCO </h1>
            <div>
...
<footer id="contato" class="footer footer-center p-10 bg-base-200 text-base-content rounded">
    ...
    <div>
      <div class="grid grid-flow-col gap-4">
        <a target="_blank" href="https://wa.me/5548991061708"><WhatsappIcon/> </a>
        <BotaoCopiaEmail/>
